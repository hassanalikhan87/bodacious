...
export const landingData = {
  ...
  company: {
    id: "company",
    mainHeading: "Software Development & Digital Solutions Company",
    description:
      "Bodacious Bulls turns visions into reality, creating innovative software, dynamic websites, and transformative applications with a global team of experts.",
    cta: {
      text: "Get Started",
    },
    quote: {
